...
git clone https://github.com/harpal1990/terraform-cloud.git
```

## Step-05: Copy files from terraform-cloud to local repo & Check-In Code
...
# Verify the same on New Remote Repository
...
- Get into newly created Organization
...
- **Connect to VCS**
  ...
  - **Selected 1 Repository:** newly created repository
  - Click on **Install**
- **Choose a Repository**
  - Newly created repository
- **Configure Settings**
  - **Workspace Name:** anyname (Whatever populated automatically leaves to defaults) 
